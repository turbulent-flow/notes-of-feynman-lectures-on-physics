...
当我们说到“概率”，它是某种猜测，我们之所以会猜测，是因为我们要基于不完整的信息或不太确定的知识去做判断。而“概率的理论”可以帮助我们更好的决策，它会谈及某种情况最有可能发生的次数，具有一致性（平均行为）。我们说，在观察中的一个特定结果发生的概率是我们对重复的观察中最有可能发生该结果的次数进行预估。以扔硬币猜正反面为例，我们扔了硬币 N 次，正面出现的次数为 A，那么观察 A 出现的概率为：
$$P(A) = N_A/N$$
