...
这个例子不存在余弦，因为作用力与位移都在同一个方向上。很容易计算 $dr/r^2$ 的积分；结果是 $-1/r$ ，所以等式[13.11](/notes-of-feynman-lectures-on-physics/volume-1/13-work-and-potential-energy-A/13-2-work-done-by-gravity.html#eq-13-11)变为：

##### eq-13-12

$$T_2-T_1=+GMm(\frac{1}{r_2}-\frac{1}{r_1})$$

因此我们有了一个有关势能的不一样的公式。等式[13.12](/notes-of-feynman-lectures-on-physics/volume-1/13-work-and-potential-energy-A/13-2-work-done-by-gravity.html#eq-13-12)告诉我们数值（ $\frac{1}{2}mv^2-GMm/r$ ），在点 1 处计算得到的，在点 2 处，或者在任意其他地方，都有一个常数值。
