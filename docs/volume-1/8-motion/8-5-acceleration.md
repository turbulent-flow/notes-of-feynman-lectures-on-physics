...
![在二维中一个物体的运动描述以及它的速度计算]({{"/assets/volume-1/fig-8-3.png"|relative_url}})
...
![由一个带着初始水平速度的坠落物体所描述的抛物线]({{"/assets/volume-1/fig-8-4.png"|relative_url}})
