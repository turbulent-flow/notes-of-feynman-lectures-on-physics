...
这个跟我们之前的表达式是一模一样的，就是那个带着 $\epsilon$ 和 $x$ 的（[Eq.8.3](/notes-of-feynman-lectures-on-physics/volume-1/8-motion/8-2-speed.html#eq-8-3)），但是它的优势在于显示出某些东西正在改变，以及追踪它的改变。
